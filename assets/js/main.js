!(function (e) {
    ...
    e("[data-bg-src]").length > 0 &&
        ...
        e(".th-slider").each(function () {
            if ($(this).hasClass("custom-swiper")) {
                return;
            }
            var t = e(this),
        ...
        e(".feature-thumb").length &&
            e(".feature-thumb").activateSliderThumbs({
                sliderTab: !0,
                tabButton: ".tab-btn",
            });
    ...
    function m() {
        window.innerWidth > 991
            ? (p ||
                  ...
                  document
                      .querySelectorAll(".allow-natural-scroll")
                      .forEach((e) => {
    ...
    if (
        ...
        e(document).on("DOMContentLoaded", function () {
            if (e(".sticky-wrapper").length > 0) {
                function t() {
                    e(".sticky-wrapper").hasClass("sticky")
                        ? e("#smooth-wrapper").css("padding-top", "0")
                        : (e(".th-header").outerHeight(),
                          e("#smooth-wrapper").css("padding-top", "0px"));
                }
                if (
                    (t(),
    ...
    window.addEventListener("pointermove", (e) => {
        ...
        gsap.ticker.add(() => {
            ...
            (C.x += (k.x - C.x) * e), (C.y += (k.y - C.y) * e), x(C.x), T(C.y);
        }),
        e(".slider-drag-wrap").on("mouseenter mouseleave", function (t) {
            e(".slider-drag-cursor").toggleClass(
                "active",
                "mouseenter" === t.type
            );
        }),
        ...
        e(document).on("DOMContentLoaded", function () {
            ...
            var t = 0,
                a = 0;
            e(".choose-progress-bar .progress-fill .counter").each(function () {
                (t += parseInt(e(this).html())), a++;
            });
            var n = Math.round(t / a) + "%";
            e("#progress-counter").html(n);
        });
    var M = {
        init: function () {
            return this.each(function () {
        ...
        (e.fn.sectionPosition = function (t, a) {
            e(this).each(function () {
                ...
                (n = Math.floor(c.height() / 2)),
                    (i = c.attr(t)),
                    (s = c.attr(a)),
                    (o = S(e(s).css("padding-top"))),
                    (r = S(e(s).css("padding-bottom"))),
                    "top-half" === i
    ...
    e("[data-sec-pos]").length &&
        ...
        e(".accordion-item-wrapp .accordion-item-content").mouseenter(
            function () {
                ...
                if (a > n && t < i) {
                    ...
                    s == Math.floor(s)
                        ...
                        e(".radial-progress").each(function (t, a) {
                            e(this)
                                .find(e("circle.bar--animated"))
                                .removeAttr("style");
                            var n = e(this).offset().top,
                                i = n + e(this).outerHeight(),
    ...
    E.on("scroll", D),
        ...
        e("[theme-color]").length > 0 &&
            e("[theme-color]").each(function () {
                var t = e(this).attr("theme-color");
                e(this).get(0).style.setProperty("--theme-color", t),
                    e(this).removeAttr("theme-color");
            }),
        e("[title-color]").length > 0 &&
            e("[title-color]").each(function () {
    ...
    var A = document.getElementById("filt-monthly"),
        I = document.getElementById("filt-yearly"),
        q = document.getElementById("switcher"),
        B = document.getElementById("monthly"),
        j = document.getElementById("yearly");
    e(".pricing-tabs").length &&
        (A.addEventListener("click", function () {
            (q.checked = !1),
                A.classList.add("toggler--is-active"),
        ...
        I.addEventListener("click", function () {
            (q.checked = !0),
                ...
                A.classList.remove("toggler--is-active"),
                B.classList.add("hide"),
                j.classList.remove("hide");
        }),
        q.addEventListener("click", function () {
            I.classList.toggle("toggler--is-active"),
                A.classList.toggle("toggler--is-active"),
    ...
    new WOW().init(),
        ...
        e(".project-item").on("mouseenter mouseleave", function (t) {
            let a = "mouseenter" === t.type ? e(this).data("bg") : "";
            e(".project-area2")
                .attr("data-background", a)
                .css("background-image", a ? `url(${a})` : "");
        }),
        ...
        (document.onkeydown = function (e) {
            // return 123 != event.keyCode && ((!e.ctrlKey || !e.shiftKey || e.keyCode != "A".charCodeAt(0)) && ((!e.ctrlKey || !e.shiftKey || e.keyCode != "C".charCodeAt(0)) && ((!e.ctrlKey || !e.shiftKey || e.keyCode != "J".charCodeAt(0)) && ((!e.ctrlKey || e.keyCode != "U".charCodeAt(0)) && void 0))))
        });
})(jQuery);
