...
@section('content')
    ...
    <section id="wsus__product_details">
        <div class="container">
            @if ($product->brand->name == 'Vertiv' && $product->product_uid != '')
                <div id="spexWidget">
                    <script type="text/JavaScript" src="//content.etilize.com/apps/spexaccess/spex-widget/spexWidget.js"
                        data-spex-auth-key="3d91e00bb5c9a81cdb1e9d87154b4a1e" data-spex-profile-id="561" data-spex-locale="en_in"
                        data-spex-etilize-product-id="{{ $product->product_uid }}" data-spex-sku-type="" data-spex-sku-number=""
                        data-spex-mfg-name="" data-spex-mfg-part-number="" data-spex-on-product-found="" data-spex-on-product-not-found=""
                        data-spex-overview-container-id="" data-spex-gallery-container-id="" data-spex-specs-container-id=""
                        data-spex-brand-container-id="" data-spex-360-view-container-id="" data-spex-videos-container-id=""
                        data-spex-only-enhanced-content="false" data-spex-disable-generated-overview="false"></script>
                </div>
            @else
                        ...
                        <div class="col-xl-7 col-md-7 col-lg-7">
                            ...
                            @endif --}}
                                @if (checkDiscount($product))
                                    <h4>{{ $settings['general']['currency_icon'] }}{{ $product->offer_price }}
                                        <del>{{ $settings['general']['currency_icon'] }}{{ $product->price }}</del>
                                    </h4>
                                @else
                                    <h4>{{ $settings['general']['currency_icon'] }}{{ $product->price }}</h4>
                                @endif
