...
class BlogController extends Controller
{
    public function blog(Request $request)
    {
        ...
        $recentPosts = Blog::where('status', 1)->orderBy('id', 'DESC')->take(5)->get();

        (new SeoHelper())->setSeoTags('blog');
    ...
    public function blogDetails(string $slug)
    {
        ...
        $seo->setSeoTags('blog.show', [
            'title'       => $blog->title . ' | TeamFrontline Blog',
        ...
        return view('frontend.blog.show', compact('blog', 'moreBlogs', 'recentBlogs', 'comments', 'categories'));
    }
